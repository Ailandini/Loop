//
//  MockLoopDataManager.swift
//  Loop
//
//  Created by Ansel Landini on 12/31/24.
...
class MockLoopDataManager {
    ...
    let basalDeliveryState: PumpManagerStatus.BasalDeliveryState? = nil
    let maxBolus: Double = 10
    let maxBasalRate: Double = 5.0
    let dosingStrategy: AutomaticDosingStrategy = .tempBasalOnly
    ...
    init(for test: DosingTestScenario) {
